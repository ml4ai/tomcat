...
some shared goal or function \citep{nowak2020insync, cooke2013Ainteractive,
...
cooke2013Binteractive, gorman2010team, letsky2008macrocognition}.
...
\begin{figure}
    \centering
    \includegraphics[width=6in]{images/marker_block_intervention_flow_chart.pdf}
    \caption{%
...
\begin{figure}
    \centering
    \includegraphics[width=6in]{images/help_request_intervention_flow_chart_cv.pdf}
    \caption{%
...
\begin{figure}
    \centering
    \includegraphics[width=6in]{images/help_request_intervention_flow_chart_re.pdf}
    \caption{%
...
If the intervention is activated, the agent will send a message to the team
member who asked for help with the following content
...
State transition rules are detailed in Figure
\ref{fig:help_request_reply_intervention_flow_chart}.
