...
asymmetry by asking and answering questions. \ap{This sounds like we are using ToM as a tool for this analysis. Is
that what you mean? If yes, how are we using ToM?  SA: Deleted}
...
constraints or multiple levels of abstraction may be best\ap{This is a strong
claim. Can you back it up with evidence? Or is it an assumption? If it is an
assumption, declare it explicitly as such.  SA: I used the words 'may be' but now I added 'we believe'} represented by a
...
\begin{enumerate}
    ...
    \item Can people listen to spoken questions and accurately decide if the
        other person's plan is sequential or hierarchical?\ap{Are not
        all plans sequential? What is the difference between simple and
        sequential plans? Prior to stating this research question, it would be good
        to provide definitions of all three of these types of plans.} Can the
        distinction between such structures improve predictive performance for
        Artificial Social Intelligence (ASI) agent intervention \ap{What does
            it mean to improve predictive performance for agent intervention?
        The connection is not obvious, you should clarify.  SA: Maybe shave this off of the registration, for now?}?
\end{enumerate}

%%%%%

The current literature for the intersection of ToM and question-\emph{asking} is sparse. Hawkins and Goodman address this scarcity and the trend of past research to focus on the optimization of answer-giving, usually through answer sets or query matching. \citep{hawkins_goodman_2017}. \ap{Cite references} \ap{Optimization of what?  SA: Done} Researchers assumed that people
...
Deciphering a person’s goal or intention from their answer to a question,
