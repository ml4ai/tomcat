...
Human teams are interpersonal dynamic systems, where the
...
\subsection{Hypothesis 1: Modeling coordination improves outcome prediction}
...
We also tested for a linear relationship with negative slope between
