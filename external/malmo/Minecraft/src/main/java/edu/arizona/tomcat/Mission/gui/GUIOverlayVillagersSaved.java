...
public class GUIOverlayVillagersSaved extends Gui {
  ...
  public void renderOverlay(RenderGameOverlayEvent event) {
    if (event.getType() == ElementType.TEXT) {
      ...
      else if (MalmoMod.instance.getClient().getTomcatClientMission() instanceof
               TutorialClientMission) {
      ...
      float fractionOfSavedVillagers =
          (float)numberOfSavedVillagers / (float)this.totalNumberOfVillagers;
