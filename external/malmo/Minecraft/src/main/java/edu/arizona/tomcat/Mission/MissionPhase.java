...
public class MissionPhase {
    ...
    /**
     * Default constructor. Sets the completion strategy to ALL_GOALS and
     * defines start as immediate
     */
    public MissionPhase() { this.init(); }

    /**
     * Constructor
     * @param completionStrategy - Indicates if the phase ends after at least
     *     one
    ...
    public void update(World world) {
        ...
        default:
            ...
            // server can only proceed after the player has provided an answer.
    ...
    private void askClientsToShowInstructions() {
        TomcatMessageData messageData =
            new TomcatMessageData(this.instructions);
    ...
    /**
     * Creates a message screen after some seconds and afterwards keep updating
     * it so it can dismiss after the time limit defined
     */
    ...
    public void handleStatusWaitingForMessageDismissal(World world) {
        int remainingSeconds =
            this.getRemainingTimeToDismissMessageScreen(world);
    ...
    /**
     * Allows the player to reread the instructions for in the middle of an
     * active phase;
     */
