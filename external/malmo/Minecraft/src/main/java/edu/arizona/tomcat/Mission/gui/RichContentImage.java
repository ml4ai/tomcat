...
public class RichContentImage {
     ...
     * @param originXIntexture - Origin of the image in the texture in the axis
     *     X
     * @param originYInTexture - Origin of the image in the texture in the axis
     *     Y
     * @param width - Width of the image in the texture
     * @param height - Height of the image in the texture
     */
    public RichContentImage(String texture,
                            String caption,
                            String subcaption,
                            int originXIntexture,
                            int originYInTexture,
                            int width,
                            int height) {
    ...
    public ResourceLocation getResourceLocation() {
        return new ResourceLocation(MalmoMod.MODID,
                                    "textures/gui/" + this.texture);
    }
     ...
     * @return
     */
    public int getOriginXInTexture() { return this.originXInTexture; }

    /**
     * Retrieves the origin of the image in the texture in the axis Y
     * @return
     */
    public int getOriginYInTexture() { return this.originYInTexture; }
