...
public class MultiRoomBuilding extends Building {
   ...
   * that.
   *
   * @return List<BlockPos> - A list of BlockPos representing the coordinates of
   ...
   * building as a list of coordinates where each coordinate corresponds to one
   * additional room. Each coordinate is a BlockPos object.
   * <p>
   * The main room is never included in this list. Use the superclass method for
   * that.
   *
   * @return List<BlockPos> - A list of BlockPos representing the coordinates of
   ...
   * mark the room of the building with that coordinate as filled. If the
   * coordinate passed is that of the main room, then that room will be marked
   * as filled. <p> If the coordinates passed are not of the main room or any of
   * the additional rooms, then nothing will change.
   *
