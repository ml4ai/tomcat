...
public class InventoryHandler {
   ...
   */
  public static void addItemToInventory(EntityPlayerMP player, ItemType type, int quantity) {
   ...
   */
  public static void addBlockToInventory(EntityPlayerMP player, BlockType type, int quantity) {
   ...
   */
  public static boolean checkItemToInventory(EntityPlayerMP player, ItemType type, int quantity) {
    Item item = MinecraftTypeHelper.ParseItemType(type.value(), false);
    ItemStack itemStack = new ItemStack(item, quantity);
