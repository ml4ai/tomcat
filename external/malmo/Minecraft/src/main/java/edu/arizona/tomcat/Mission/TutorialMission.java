...
public class TutorialMission extends Mission {
	...
	protected void createPhases() {
		...
		/*
		 * TODO - The crafting phase is going to be commented out until we have crafting in our main mission.
		 * So far, there's no crafting so there's no need to present this in the tutorial		 
		 */
...
//	}
	...
	/**
	 * Creates a phase in the mission where the objective is to battle and kill a
	 * skeleton
	 */
...
0.05 till 30 such ticks (1.5 second) have passed for each view */
	...
	protected void beforePhaseTrasition() {
		if (this.currentPhase.equals(this.enterTheArenaPhase)) {
			...
			/*
			 * TODO - This should be commented out until the crafting phase reactivated
			 */
			//this.shouldaddMaterialsToUsersInventory = true;
			
			/*
			 * TODO - The code below should be moved to a new condition block after the 
			 * crafting phase is reactivated, since the entities must be spawned in 
			 * the mission after the crafting phase instead of the approaching pools one.
			 */
