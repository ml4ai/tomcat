...
public class SelfReportContent {
    ...
    public static SelfReportContent createFromJson(String filename) {
        ...
        InputStream inputStream =
            MalmoMod.instance.getClass().getClassLoader().getResourceAsStream(
                path);
        ...
        if (content.filenameRichContentAfterQuestions != null &&
            ...
            content.richContentAfterQuestions = RichContent.createFromJson(
                content.filenameRichContentAfterQuestions);
        }
        return content;
    }
    ...
    public void setTextPlaceholder(int placeholderIndex, String text) {
        ...
        if (this.richContentAfterQuestions != null) {
            this.richContentAfterQuestions.setTextPlaceholder(placeholderIndex,
                                                              text);
        }
    }
