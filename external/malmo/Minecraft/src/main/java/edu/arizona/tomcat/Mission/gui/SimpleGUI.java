...
public class SimpleGUI extends GuiScreen {
	...
	public void initGui() {
		...
		buttonList.add(new GuiButton(SCARED_BUTTON_ID, (width - 220) / 2, height / 2, 100, 20, "Scared"));
		buttonList.add(new GuiButton(CALM_BUTTON_ID, (width - 220) / 2 + 120, height / 2, 100, 20, "Calm"));		
	}
