...
public class TomcatMessageData {
    ...
    /**
     * Reads the .json content of a buffer and loads it to the attributes of
     * this class
    ...
    /**
     * Convert the attributes of this class to a .json string and write it to
     * the buffer
     * @param buffer - ByteBuffer object
     * @throws IOException
     */
     ...
     * @throws IOException
     */
    protected String readStringFromByteBuffer(ByteBuf buffer)
        throws IOException {
     ...
     * @param remainingSeconds - remaining time in seconds for the mission to
     *     end
     */
