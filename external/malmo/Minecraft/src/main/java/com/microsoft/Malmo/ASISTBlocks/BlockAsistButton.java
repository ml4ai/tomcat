...
public class BlockAsistButton extends BlockButton {
    ...
    private static Set<BlockPos> buttonDoorPositions = new HashSet<BlockPos>();

    private void initButtonDoorSet() {
        buttonDoorPositions.add(new BlockPos());
    }
    ...
    public boolean onBlockActivated(World worldIn,
        ...
        DiscreteEventsHelper.printEventOccurence(pos, playerIn, "Button Pressed"); // Used to mark discrete occurence
