...
public class TurnBasedCommandsImplementation
  ...
  public boolean parseParameters(Object params) {
    ...
    if (params instanceof TurnBasedCommands) {
      ...
      // Create our partner observation producer, and manually add it to the
      // mission behaviour:
      ...
      // Now instantiate our child handlers. We can use a new MissionBehaviour
      // object to take care of this.
  ...
  onExecute(String verb, String parameter, MissionInit missionInit) {
    // Firstly, reject any command that doesn't match the single-use turn key
    ...
    // parameters. CommandGroup.onExecute rejoins the verb and parameter before
    // passing to the children, so we can pass an empty verb, and the right
    // thing will happen.
