...
public class AgentQuitFromReachingCommandQuotaImplementation
    ...
    public boolean parseParameters(Object params) {
        if (params == null ||
            !(params instanceof AgentQuitFromReachingCommandQuota))
            return false;
    ...
    public void prepare(MissionInit missionInit) {
        ...
        // quota usage. To do this we create our own command handler and insert
        // it at the root of the command chain. This is also how the
        // ObservationFromRecentCommands and RewardForSendingCommands handlers
        // work. It's slightly dirty behaviour, but it's cleaner than the other
        // options!
