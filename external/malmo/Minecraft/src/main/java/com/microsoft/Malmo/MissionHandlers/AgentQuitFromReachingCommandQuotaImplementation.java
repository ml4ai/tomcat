...
public class AgentQuitFromReachingCommandQuotaImplementation
  ...
  public void prepare(MissionInit missionInit) {
    ...
    // quota usage. To do this we create our own command handler and insert it
    // at the root of the command chain. This is also how the
    // ObservationFromRecentCommands and RewardForSendingCommands handlers work.
