    ...
    */
    class ImageCapture {
      ...
      public:
        ...
        bool OpenDirectory(std::string directory,
        ...
        // Getting the most recent grayscale frame (need to call GetNextImage
        // first)
        ...
        // Parameters describing the sequence and it's progress (what's the
        // proportion of images opened)
        double GetProgress();
      ...
      private:
        ...
        // readers pointed at the same source
        ...
        // Could optionally read the bounding box locations from files (each
        // image could have multiple bounding boxes)
