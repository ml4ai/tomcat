...
bool RecorderCSV::Open(std::string output_file_name,
                       bool is_sequence,
    ...
    if (output_gaze) {
        output_file << ", gaze_0_x, gaze_0_y, gaze_0_z, gaze_1_x, gaze_1_y, "
                       "gaze_1_z, gaze_angle_x, gaze_angle_y";
    ...
    // Outputting model parameters (rigid and non-rigid), the first parameters
    // are the 6 rigid shape parameters, they are followed by the non rigid
    // shape parameters
