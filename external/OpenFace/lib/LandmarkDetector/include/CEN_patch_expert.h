    ...
    */
    ...
    class CEN_patch_expert {
      public:
        ...
        // Confidence of the current patch expert (used for NU_RLMS
        // optimisation)
        double confidence;
        ...
        // For frontal faces can apply mirrored and non-mirrored experts at the
        // same time
    ...
    void interpolationMatrix(cv::Mat_<float>& mapMatrix,
                             int response_height,
                             int response_width,
                             int input_width,
                             int input_height);
