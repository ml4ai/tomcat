...
namespace LandmarkDetector {
    ...
    //================================================================================================================
    // Landmark detection in videos, need to provide an image and model
    // parameters (default values work well) Optionally can provide a bounding
    // box from which to start tracking Can also optionally pass a grayscale
    // image if it has already been computed to speed things up a bit
    //================================================================================================================
