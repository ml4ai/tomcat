...
public
  ...
  public:
    ...
    void AddNextFrame(CppInterop::LandmarkDetector::CLNF ^ clnf,
                      bool success,
                      float fx,
                      float fy,
                      float cx,
      ...
      GazeAnalysis::EstimateGaze(
          *clnf->getCLNF(), *gazeDirection0, fx, fy, cx, cy, true);
      GazeAnalysis::EstimateGaze(
          *clnf->getCLNF(), *gazeDirection1, fx, fy, cx, cy, false);
      ...
      *gazeAngle = GazeAnalysis::GetGazeAngle(*gazeDirection0, *gazeDirection1);
      ...
      cv::Mat_<float> eyeLdmks3d_left =
          clnf->getCLNF()->hierarchical_models[part_left].GetShape(
              fx, fy, cx, cy);
      cv::Point3f pupil_left_h =
          GazeAnalysis::GetPupilPosition(eyeLdmks3d_left);
      pupil_left->x = pupil_left_h.x;
      pupil_left->y = pupil_left_h.y;
      pupil_left->z = pupil_left_h.z;

      cv::Mat_<float> eyeLdmks3d_right =
          clnf->getCLNF()->hierarchical_models[part_right].GetShape(
              fx, fy, cx, cy);
    ...
    System::Tuple<System::Tuple<float, float, float> ^,
        ...
        GetGazeAngle() {
          auto gaze_angle = gcnew System::Tuple<float, float>((*gazeAngle)[0],
                                                              (*gazeAngle)[1]);
          return gaze_angle;
        } System::Collections::Generic::
            List<System::Tuple<System::Windows::Point,
        ...
        CalculateGazeLines(float fx, float fy, float cx, float cy) {
          ...
          auto lines = gcnew System::Collections::Generic::List<
              System::Tuple<System::Windows::Point,
                            System::Windows::Point> ^>();
