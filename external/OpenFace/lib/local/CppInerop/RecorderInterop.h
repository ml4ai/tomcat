...
public
  ...
  public:
    RecorderOpenFaceParameters(bool sequence,
      ...
      m_params = new Utilities::RecorderOpenFaceParameters(sequence,
                                                           is_from_webcam,
                                                           output_2D_landmarks,
                                                           output_3D_landmarks,
                                                           output_model_params,
...
public
  ...
  public:
    ...
    void SetObservationGaze(
        System::Tuple<float, float, float> ^ gaze_direction0,
      ...
      cv::Point3f gaze_direction0_cv(gaze_direction0->Item1,
                                     gaze_direction0->Item2,
                                     gaze_direction0->Item3);
      cv::Point3f gaze_direction1_cv(gaze_direction1->Item1,
                                     gaze_direction1->Item2,
                                     gaze_direction1->Item3);
      ...
      m_recorder->SetObservationGaze(gaze_direction0_cv,
                                     gaze_direction1_cv,
                                     gaze_angle_cv,
                                     landmarks_2D_cv,
                                     landmarks_3D_cv);
    ...
    void
    SetObservationActionUnits(Dictionary<System::String ^, double> ^ au_regs,
                              Dictionary<System::String ^, double> ^ au_class) {
    ...
    void SetObservationFaceAlign(OpenCVWrappers::RawImage ^
                                 aligned_face_image) {
    ...
    void SetObservationLandmarks(List<System::Tuple<float, float> ^> ^
                                 ...
                                 List<System::Tuple<float, float, float> ^> ^
                                     landmarks_3D,
                                 List<float> ^ params_global,
                                 List<float> ^ params_local,
                                 double confidence,
                                 bool success) {
      // Construct an OpenCV matrix from the landmarks
      ...
      cv::Vec6f params_global_vec(params_global[0],
                                  params_global[1],
                                  params_global[2],
                                  params_global[3],
                                  params_global[4],
      ...
      m_recorder->SetObservationLandmarks(landmarks_2D_mat,
                                          landmarks_3D_mat,
                                          params_global_vec,
                                          params_local_vec,
                                          confidence,
