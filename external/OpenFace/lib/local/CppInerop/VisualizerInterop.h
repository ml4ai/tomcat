...
public
  ...
  public:
    ...
    void SetObservationGaze(
      ...
      m_visualizer->SetObservationGaze(gaze_direction0_cv,
                                       gaze_direction1_cv,
                                       landmarks_2D_cv,
                                       landmarks_3D_cv,
                                       confidence);
    ...
    void SetObservationLandmarks(List<System::Tuple<float, float> ^> ^
      ...
      m_visualizer->SetObservationLandmarks(
          landmarks_2D_mat, confidence, visibilities_cv);
    }
    ...
    void SetImage(OpenCVWrappers::RawImage ^ canvas,
                  float fx,
                  float fy,
                  float cx,
                  float cy) {
