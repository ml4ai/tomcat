...
from dataset_pipeline.common.config import LOG_DIR, TMP_DIR, configure_logging
from dataset_pipeline.common.experiments_crawler import ExperimentsCrawler
from dataset_pipeline.common.utils import convert_unix_timestamp_to_iso8601
from dataset_pipeline.database.config import get_db
from dataset_pipeline.database.entity.signal.audio_vocalics import AudioVocalics
from dataset_pipeline.database.entity.task.minecraft_task import MinecraftMission
from dataset_pipeline.model.audio.pcm_audio import PCMAudio
...
def process_vocalics():
    configure_logging(f"{LOG_DIR}/extract_vocalic_features.log")
