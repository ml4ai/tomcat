...
from dataset_pipeline.common.constants import EEG_FREQUENCY
from dataset_pipeline.common.utils import convert_unix_timestamp_to_iso8601
from dataset_pipeline.database.entity.derived.gsr_sync import GSRSync
    ...
    def has_saved_sync_data(self, target_frequency: int) -> bool:
        ...
        num_records = db.scalar(
            select(func.count(GSRSync.id)).where(
                ...
                GSRSync.station_id == self.station,
            )
        )
        db.close()
