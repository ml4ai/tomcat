...
if __name__ == "__main__":
    ...
    for from_client_connection, client_name in server.from_client_connections.items():
        ...
        process = Process(target=_run_affective_task, 
                          args=([to_client_connection], {from_client_connection: client_name}, session_name, args.save, args.debug))
    ...
    for session_id, (to_client_connection_pair, from_client_connection_pair) in enumerate(client_pairs):
        ...
        process = Process(target=_run_ping_pong, args=(to_client_connections, from_client_connection_pair, session_name, True, args.save, args.debug))
    ...
    for session_id, (to_client_connection_teams, from_client_connection_teams) in enumerate(client_pairs):
        ...
        process = Process(target=_run_ping_pong, args=(to_client_connections, from_client_connection_teams, session_name, False, args.save, args.debug))
        ping_pong_processes.append(process)
