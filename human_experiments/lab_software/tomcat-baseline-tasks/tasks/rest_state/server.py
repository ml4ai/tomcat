...
from .config import DEBUG_REST_TIMER, REST_TIMER


class ServerRestState:
    def __init__(self, to_client_connections: list,
        ...
        header = ['time', 'monotonic_time', 'human_readable_time', 'event_type']
    ...
    def run(self):
        ...
        data["type"] = "state"
        data["state"] = {}
        data["state"]["rest_timer"] = REST_TIMER if not self._debug_mode else DEBUG_REST_TIMER
