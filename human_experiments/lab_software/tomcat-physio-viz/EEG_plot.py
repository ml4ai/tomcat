...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.channel_list = ['AFF1h', 'AFF5h', 'F7', 'FC5', 'FC1', 'C3', 'T7', 'TP9', 'CP5', 'CP1', 'Pz', 'P3',
                             'P7', 'PO9', 'O1', 'Oz', 'O2', 'PO10', 'P8', 'P4', 'TP10', 'CP6', 'CP2', 'Cz',
                             'C4', 'T8', 'FC6', 'FC2', 'FCz', 'F8', 'AFF6h', 'AFF2h', 'AUX_GSR', 'AUX_EKG',]
        
        #Since 11/22 the lab decided to use the following channels:

        self.channels_used = ['AFF1h', 'F7', 'FC5', 'C3', 'T7', 'TP9', 'Pz', 'P3', 'P7', 'O1', 'O2', 'P8', 
                            'P4', 'TP10', 'Cz', 'C4', 'T8', 'FC6', 'FCz', 'F8', 'AFF2h', 'AUX_GSR', 'AUX_EKG',]

        #Get the index of channel that are being used.

        self.channels_used_index = [self.channel_list.index(ch) for ch in self.channels_used if ch in self.channel_list]
