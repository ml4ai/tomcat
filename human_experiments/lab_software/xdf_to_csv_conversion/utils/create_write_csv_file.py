...
def get_timestamps_from_dict(df, state, dict, column_name, data, stream_type, output_path, pth):
    df_temp = df
    state_temp = state
    ...
    *_state_time_stop from our dataframe. Then insert
    ...
    for idx, dict in all_task_time.items():
        if 'rest_state' in dict.values():
            ...
            state = 'rest_state'
            get_state_rest = get_timestamps_from_dict(df, state, dict, header[2], data, stream_type, output_path, pth = data_path + '/')
        ...
        if 'finger_tapping' in dict.values():
            ...
            get_state_fingertap = get_timestamps_from_dict(df, state, dict, header[2], data, stream_type, output_path, pth = data_path + '/')
        ...
        if 'affective_task_individual' in dict.values() and any((str(iMac) in path) for iMac in dict.values()):
            ...
            affective_task_individual = get_timestamps_from_dict(df, state, dict, header[2], data, stream_type, output_path, pth = data_path + '/')
        ...
        if 'affective_task_team' in dict.values():
            ...
            get_state_affective_team = get_timestamps_from_dict(df, state, dict, header[2], data, stream_type, output_path, pth = data_path + '/')
        ...
        if 'ping_pong_cooperative_0' in dict.values():
            ...
            get_state_pingpong_coop_0 = get_timestamps_from_dict(df, state, dict, header[2], data, stream_type, output_path, pth = data_path + '/')
        ...
        if 'ping_pong_competetive_0' in dict.values():
            ...
            get_state_pingpong_comp_0 = get_timestamps_from_dict(df, state, dict, header[2], data, stream_type, output_path, pth = data_path + '/')
        ...
        if 'ping_pong_competetive_1' in dict.values():
            ...
            get_state_pingpong_comp_1 = get_timestamps_from_dict(df, state, dict, header[2], data, stream_type, output_path, pth = data_path + '/')
        ...
        if 'hands_on_training' in dict.values():
            ...
            mincraft_handson_training = get_timestamps_from_dict(df, state, dict, header[2], data, stream_type, output_path, pth = data_path + '/')
        ...
        if 'saturn_a' in dict.values():
            ...
            state = 'saturn_a'
            mincraft_saturn_a = get_timestamps_from_dict(df, state, dict, header[2], data, stream_type, output_path, pth = data_path + '/')
        ...
        if 'saturn_b' in dict.values():
            ...
            state = 'saturn_b'
            mincraft_saturn_b = get_timestamps_from_dict(df, state, dict, header[2], data, stream_type, output_path, pth = data_path + '/')
