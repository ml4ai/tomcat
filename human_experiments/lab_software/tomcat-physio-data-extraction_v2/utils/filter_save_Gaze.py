...
def save_Gaze(lion_0297_block_Gaze_labeled, tiger_0239_block_Gaze_labeled, leopard_0171_block_Gaze_labeled, input_path, output_path, extract_pkl, extract_csv, extract_hdf5, filter):
    # Construct a dictionary to loop through
    df_dict = {"lion": lion_0297_block_Gaze_labeled, "tiger": tiger_0239_block_Gaze_labeled, "leopard": leopard_0171_block_Gaze_labeled}
