...
class PingPongCooperativeTaskObservation(Base):
    ...
    player_3_id: Mapped[int] = mapped_column(Integer, ForeignKey("participant.id"), primary_key=True)
    ...
    def __init__(self, group_session_id: str, player_1_id: int, player_2_id: int, player_3_id: int, timestamp_unix: str,
                 timestamp_iso8601: str, task_started: bool, seconds: int, ball_position_x: int, ball_position_y: int,
                 player_1_paddle_position_x: int, player_1_paddle_position_y: int, player_2_paddle_position_x: int,
                 player_2_paddle_position_y: int, player_3_paddle_position_x: int, player_3_paddle_position_y: int,
                 ai_paddle_position_x: int, ai_paddle_position_y: int, team_score: int, ai_score: int):
        super().__init__()
        ...
        self.player_3_paddle_position_x = player_3_paddle_position_x
        self.player_3_paddle_position_y = player_3_paddle_position_y
        self.ai_paddle_position_x = ai_paddle_position_x
        self.ai_paddle_position_y = ai_paddle_position_y
