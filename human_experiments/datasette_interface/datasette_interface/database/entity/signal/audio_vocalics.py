...
class AudioVocalics(Base):
    ...
    minecraft_mission_id: Mapped[str] = mapped_column(
        "minecraft_mission_id", Text, ForeignKey(MinecraftMission.id), primary_key=True
    )
    ...
    voicingfinalunclipped_sma: Mapped[float] = mapped_column(
        "voicingfinalunclipped_sma", REAL
    )
    ...
    audspec_lengthl1norm_sma: Mapped[float] = mapped_column(
        "audspec_lengthl1norm_sma", REAL
    )
    audspecrasta_lengthl1norm_sma: Mapped[float] = mapped_column(
        "audspecrasta_lengthl1norm_sma", REAL
    )
    ...
    wave_fftmag_fband250_650_sma: Mapped[float] = mapped_column(
        "wave_fftmag_fband250-650_sma", REAL
    )
    wave_fftmag_fband1000_4000_sma: Mapped[float] = mapped_column(
        "wave_fftmag_fband1000-4000_sma", REAL
    )
    ...
    wave_fftmag_spectralflux_sma: Mapped[float] = mapped_column(
        "wave_fftmag_spectralflux_sma", REAL
    )
    ...
    wave_fftmag_spectralslope_sma: Mapped[float] = mapped_column(
        "wave_fftmag_spectralslope_sma", REAL
    )
    wave_fftmag_psysharpness_sma: Mapped[float] = mapped_column(
        "wave_fftmag_psysharpness_sma", REAL
    )
    ...
    voicingfinalunclipped_sma_de: Mapped[float] = mapped_column(
        "voicingfinalunclipped_sma_de", REAL
    )
    ...
    audspec_lengthl1norm_sma_de: Mapped[float] = mapped_column(
        "audspec_lengthl1norm_sma_de", REAL
    )
    ...
    audspec_rfilt_sma_de0: Mapped[float] = mapped_column(
        "audspec_rfilt_sma_de[0]", REAL
    )
    audspec_rfilt_sma_de1: Mapped[float] = mapped_column(
        "audspec_rfilt_sma_de[1]", REAL
    )
    audspec_rfilt_sma_de2: Mapped[float] = mapped_column(
        "audspec_rfilt_sma_de[2]", REAL
    )
    audspec_rfilt_sma_de3: Mapped[float] = mapped_column(
        "audspec_rfilt_sma_de[3]", REAL
    )
    audspec_rfilt_sma_de4: Mapped[float] = mapped_column(
        "audspec_rfilt_sma_de[4]", REAL
    )
    audspec_rfilt_sma_de5: Mapped[float] = mapped_column(
        "audspec_rfilt_sma_de[5]", REAL
    )
    audspec_rfilt_sma_de6: Mapped[float] = mapped_column(
        "audspec_rfilt_sma_de[6]", REAL
    )
    audspec_rfilt_sma_de7: Mapped[float] = mapped_column(
        "audspec_rfilt_sma_de[7]", REAL
    )
    audspec_rfilt_sma_de8: Mapped[float] = mapped_column(
        "audspec_rfilt_sma_de[8]", REAL
    )
    audspec_rfilt_sma_de9: Mapped[float] = mapped_column(
        "audspec_rfilt_sma_de[9]", REAL
    )
    audspec_rfilt_sma_de10: Mapped[float] = mapped_column(
        "audspec_rfilt_sma_de[10]", REAL
    )
    audspec_rfilt_sma_de11: Mapped[float] = mapped_column(
        "audspec_rfilt_sma_de[11]", REAL
    )
    audspec_rfilt_sma_de12: Mapped[float] = mapped_column(
        "audspec_rfilt_sma_de[12]", REAL
    )
    audspec_rfilt_sma_de13: Mapped[float] = mapped_column(
        "audspec_rfilt_sma_de[13]", REAL
    )
    audspec_rfilt_sma_de14: Mapped[float] = mapped_column(
        "audspec_rfilt_sma_de[14]", REAL
    )
    audspec_rfilt_sma_de15: Mapped[float] = mapped_column(
        "audspec_rfilt_sma_de[15]", REAL
    )
    audspec_rfilt_sma_de16: Mapped[float] = mapped_column(
        "audspec_rfilt_sma_de[16]", REAL
    )
    audspec_rfilt_sma_de17: Mapped[float] = mapped_column(
        "audspec_rfilt_sma_de[17]", REAL
    )
    audspec_rfilt_sma_de18: Mapped[float] = mapped_column(
        "audspec_rfilt_sma_de[18]", REAL
    )
    audspec_rfilt_sma_de19: Mapped[float] = mapped_column(
        "audspec_rfilt_sma_de[19]", REAL
    )
    audspec_rfilt_sma_de20: Mapped[float] = mapped_column(
        "audspec_rfilt_sma_de[20]", REAL
    )
    audspec_rfilt_sma_de21: Mapped[float] = mapped_column(
        "audspec_rfilt_sma_de[21]", REAL
    )
    audspec_rfilt_sma_de22: Mapped[float] = mapped_column(
        "audspec_rfilt_sma_de[22]", REAL
    )
    audspec_rfilt_sma_de23: Mapped[float] = mapped_column(
        "audspec_rfilt_sma_de[23]", REAL
    )
    audspec_rfilt_sma_de24: Mapped[float] = mapped_column(
        "audspec_rfilt_sma_de[24]", REAL
    )
    audspec_rfilt_sma_de25: Mapped[float] = mapped_column(
        "audspec_rfilt_sma_de[25]", REAL
    )
    ...
    voicingfinalunclipped_sma_de_1: Mapped[float] = mapped_column(
        "voicingfinalunclipped_sma_de.1", REAL
    )
    ...
    audspec_lengthl1norm_sma_de_1: Mapped[float] = mapped_column(
        "audspec_lengthl1norm_sma_de.1", REAL
    )
    audspecrasta_lengthl1norm_sma_de_1: Mapped[float] = mapped_column(
        "audspecrasta_lengthl1norm_sma_de.1", REAL
    )
    wave_rmsenergy_sma_de_1: Mapped[float] = mapped_column(
        "wave_rmsenergy_sma_de.1", REAL
    )
    wave_zcr_sma_de_1: Mapped[float] = mapped_column("wave_zcr_sma_de.1", REAL)
    audspec_rfilt_sma_de0_1: Mapped[float] = mapped_column(
        "audspec_rfilt_sma_de[0].1", REAL
    )
    audspec_rfilt_sma_de1_1: Mapped[float] = mapped_column(
        "audspec_rfilt_sma_de[1].1", REAL
    )
    audspec_rfilt_sma_de2_1: Mapped[float] = mapped_column(
        "audspec_rfilt_sma_de[2].1", REAL
    )
    audspec_rfilt_sma_de3_1: Mapped[float] = mapped_column(
        "audspec_rfilt_sma_de[3].1", REAL
    )
    audspec_rfilt_sma_de4_1: Mapped[float] = mapped_column(
        "audspec_rfilt_sma_de[4].1", REAL
    )
    audspec_rfilt_sma_de5_1: Mapped[float] = mapped_column(
        "audspec_rfilt_sma_de[5].1", REAL
    )
    audspec_rfilt_sma_de6_1: Mapped[float] = mapped_column(
        "audspec_rfilt_sma_de[6].1", REAL
    )
    audspec_rfilt_sma_de7_1: Mapped[float] = mapped_column(
        "audspec_rfilt_sma_de[7].1", REAL
    )
    audspec_rfilt_sma_de8_1: Mapped[float] = mapped_column(
        "audspec_rfilt_sma_de[8].1", REAL
    )
    audspec_rfilt_sma_de9_1: Mapped[float] = mapped_column(
        "audspec_rfilt_sma_de[9].1", REAL
    )
    audspec_rfilt_sma_de10_1: Mapped[float] = mapped_column(
        "audspec_rfilt_sma_de[10].1", REAL
    )
    audspec_rfilt_sma_de11_1: Mapped[float] = mapped_column(
        "audspec_rfilt_sma_de[11].1", REAL
    )
    audspec_rfilt_sma_de12_1: Mapped[float] = mapped_column(
        "audspec_rfilt_sma_de[12].1", REAL
    )
    audspec_rfilt_sma_de13_1: Mapped[float] = mapped_column(
        "audspec_rfilt_sma_de[13].1", REAL
    )
    audspec_rfilt_sma_de14_1: Mapped[float] = mapped_column(
        "audspec_rfilt_sma_de[14].1", REAL
    )
    audspec_rfilt_sma_de15_1: Mapped[float] = mapped_column(
        "audspec_rfilt_sma_de[15].1", REAL
    )
    audspec_rfilt_sma_de16_1: Mapped[float] = mapped_column(
        "audspec_rfilt_sma_de[16].1", REAL
    )
    audspec_rfilt_sma_de17_1: Mapped[float] = mapped_column(
        "audspec_rfilt_sma_de[17].1", REAL
    )
    audspec_rfilt_sma_de18_1: Mapped[float] = mapped_column(
        "audspec_rfilt_sma_de[18].1", REAL
    )
    audspec_rfilt_sma_de19_1: Mapped[float] = mapped_column(
        "audspec_rfilt_sma_de[19].1", REAL
    )
    audspec_rfilt_sma_de20_1: Mapped[float] = mapped_column(
        "audspec_rfilt_sma_de[20].1", REAL
    )
    audspec_rfilt_sma_de21_1: Mapped[float] = mapped_column(
        "audspec_rfilt_sma_de[21].1", REAL
    )
    audspec_rfilt_sma_de22_1: Mapped[float] = mapped_column(
        "audspec_rfilt_sma_de[22].1", REAL
    )
    audspec_rfilt_sma_de23_1: Mapped[float] = mapped_column(
        "audspec_rfilt_sma_de[23].1", REAL
    )
    audspec_rfilt_sma_de24_1: Mapped[float] = mapped_column(
        "audspec_rfilt_sma_de[24].1", REAL
    )
    audspec_rfilt_sma_de25_1: Mapped[float] = mapped_column(
        "audspec_rfilt_sma_de[25].1", REAL
    )
