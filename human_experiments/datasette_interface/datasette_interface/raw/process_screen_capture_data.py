...
from datasette_interface.raw.common.process_raw_signals import (create_indices, label_data,
...
def process_screen_capture_data():
    ...
    insert_raw_unlabeled_data(settings.drop_table, ScreenCapture, "screen capture", "Screen",
                              "screenshots")
