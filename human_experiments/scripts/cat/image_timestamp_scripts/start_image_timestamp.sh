...
__tmux_start_image_timestamp() {
    ...
    local experiment_block=$2

    local monitoring_lion_face="$experiment_path/lion/face_images/block_$experiment_block"
    local monitoring_lion_screen="$experiment_path/lion/screenshots/block_$experiment_block"
    local monitoring_tiger_face="$experiment_path/tiger/face_images/block_$experiment_block"
    local monitoring_tiger_screen="$experiment_path/tiger/screenshots/block_$experiment_block"
    local monitoring_leopard_face="$experiment_path/leopard/face_images/block_$experiment_block"
    local monitoring_leopard_screen="$experiment_path/leopard/screenshots/block_$experiment_block"
