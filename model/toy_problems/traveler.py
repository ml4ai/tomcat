...
def build_pgm(complete_generative_model=False):
    ...
    if complete_generative_model:
        ...
        # Parameter CPDs
        cpds.append(CPD(prior_city, [], [Dirichlet([1, 0.1, 0.1, 0.1])]))
        ...
        cpds.append(CPD(param_city_a_to_sensor_a, [], [Beta(5, 1)]))
        cpds.append(CPD(param_city_b_to_sensor_a, [], [Beta(1, 3)]))
        cpds.append(CPD(param_city_c_to_sensor_a, [], [Beta(1, 3)]))
        cpds.append(CPD(param_city_d_to_sensor_a, [], [Beta(1, 3)]))
        cpds.append(CPD(param_city_a_to_sensor_b, [], [Beta(1, 3)]))
        cpds.append(CPD(param_city_b_to_sensor_b, [], [Beta(5, 1)]))
        cpds.append(CPD(param_city_c_to_sensor_b, [], [Beta(1, 3)]))
        cpds.append(CPD(param_city_d_to_sensor_b, [], [Beta(1, 3)]))
        cpds.append(CPD(param_city_a_to_sensor_c, [], [Beta(1, 3)]))
        cpds.append(CPD(param_city_b_to_sensor_c, [], [Beta(1, 3)]))
        cpds.append(CPD(param_city_c_to_sensor_c, [], [Beta(5, 1)]))
        cpds.append(CPD(param_city_d_to_sensor_c, [], [Beta(1, 3)]))
        cpds.append(CPD(param_city_a_to_sensor_d, [], [Beta(1, 3)]))
        cpds.append(CPD(param_city_b_to_sensor_d, [], [Beta(1, 3)]))
        cpds.append(CPD(param_city_c_to_sensor_d, [], [Beta(1, 3)]))
        cpds.append(CPD(param_city_d_to_sensor_d, [], [Beta(5, 1)]))
