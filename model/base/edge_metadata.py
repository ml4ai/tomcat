...
class EdgeMetadata:
    ...
    def __init__(self, node_from, node_to, forward_in_time=False):
        ...
        if not isinstance(node_from, NodeMetadata) or not isinstance(node_to, NodeMetadata):
            raise TypeError('The nodes have to be instances of the class NodeMetadata')
