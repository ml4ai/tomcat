...
json::object ReferenceAgent::get_input_config(json::object config){
    return get_object("reference_agent_input", config);
}

json::object ReferenceAgent::get_output_config(json::object config){
    return get_object("reference_agent_output", config);
}

json::object ReferenceAgent::get_output_data(json::object input_data){
