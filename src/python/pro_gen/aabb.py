...
class AABB:
    ...
    def get_midpoint_x(self):
        middle_x = (
            ...
            + (self.get_bottom_right().get_x() - self.get_top_left().get_x())
            // 2
        )
        return middle_x
    ...
    def get_midpoint_z(self):
        middle_z = (
            ...
            + (self.get_bottom_right().get_z() - self.get_top_left().get_z())
            // 2
        )
        return middle_z
    ...
    def get_midpoint_y(self):
        middle_y = (
            ...
            + (self.get_bottom_right().get_y() - self.get_top_left().get_y())
            // 2
        )
        return middle_y
