...
//  }
    ...
    CascadeClassifier faceDetector("/Users/adam/git/tomcat/src/lbpcascade_frontalface.xml");

    // creat object of facemark
    Ptr<Facemark> facemark = FacemarkLBF::create();

    // load facemark model lbfmodel.yml
    facemark->loadModel("/Users/adam/git/tomcat/src/lbfmodel.yaml");
