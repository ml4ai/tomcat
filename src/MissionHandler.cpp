...
namespace tomcat {
  ...
  void MissionHandler::startMission() { this->mission->buildWorld(); }
  ...
  void MissionHandler::observeHotBar() { this->mission->observeHotBar(); }

  void MissionHandler::observeFullInventory() {
    this->mission->observeFullInventory();
  }

  void MissionHandler::observeChat() { this->mission->observeChat(); }
