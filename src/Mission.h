...
namespace tomcat {
    ...
    public:
        ...
        /**
         * Build the world with all the features and elements the mission must have. This method must 
         * be overwritten by the subclasses of Mission to specify the details of a concrete mission.
         */
    ...
    protected:
         ...
         * @param orientation - South to North, North to South, West to East or East to West
         * @param blockType - Type of block which the stairs are made out of
         */
        void drawStairs(int fromX, int fromZ, int fromY, int width, int height, int orientation, std::string blockType = "stone");
         ...
         */
        void drawPlane(int fromX, int fromZ, int fromY, int width, int height, int depth, std::string blockType);
         ...
         */
        void drawRoom(int fromX, int fromZ, int fromY, int width, int height, int depth, bool withRoof = true, std::string blockType = "stone");
         ...
         */
        void drawRoof(int fromX, int fromZ, int groundFloorLevel, int width, int height, int depth, std::string blockType = "stone");
         ...
         */
        void makeHole(int fromX, int fromZ, int fromY, int width, int height, int depth);

        enum orientation { west_east = 1, east_west = 2, south_north = 3, north_south = 4};
