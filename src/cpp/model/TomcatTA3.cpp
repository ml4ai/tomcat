...
namespace tomcat {
    namespace model {
        ...
        //        unordered_map<string, shared_ptr<RandomVariableNode>>
        //        Tomcat::get_ta3_v2_nodes() {
        //            int num_states = 4;
        //            int num_training_conditions = 3;
        //
        //            unordered_map<string, shared_ptr<RandomVariableNode>>
        //            nodes =
        //                this->get_ta3_v1_nodes();
        //
        //            // We will replace the transition matrix that in version 1
        //            only
        //            // depends on the previous state by a new one that depends
        //            on the
        //            // training condition Q and the previous state.
        //
        //            // 1. Parameter nodes
        //
        //            // 1.1 States
        ...
        //            // 1.1.1 Metadata
        //            vector<shared_ptr<NodeMetadata>> theta_s_metadatas(
        //                num_training_conditions * num_states);
        //
        //            for (int i = 0; i < num_training_conditions * num_states;
        //            i++) {
        //                stringstream parameter_label;
        //                parameter_label << THETA_S << i;
        //
        ...
        //            vector<shared_ptr<DirichletCPD>> theta_s_cpds(
        //                num_training_conditions * num_states);
        //            for (int i = 0; i < num_training_conditions; i++) {
        //                // From HW to HW | RW | SG | SY
        //                Eigen::MatrixXd theta_s0(1, num_states);
        //                theta_s0 << 1, 1, EPSILON, EPSILON;
        //                DirichletCPD theta_s_cpd_temp({}, theta_s0);
        //                theta_s_cpds[0] =
        //                    make_shared<DirichletCPD>(move(theta_s_cpd_temp));
        //
        //                // From RW to HW | RW | SG | SY
        //                Eigen::MatrixXd theta_s1(1, num_states);
        //                theta_s1 << 1, 1, 1, 1;
        ...
        //
        //            // 2.1 Metadata
        //            NodeMetadata training_condition_metadata_temp =
        //                NodeMetadata::create_multiple_time_link_metadata(
        //                    Q, false, false, false, 1, 1,
        //                    num_training_conditions);
        //            shared_ptr<NodeMetadata> training_condition_metadata =
        //                make_shared<NodeMetadata>(
        //                    move(training_condition_metadata_temp));
        //
        //            // 2.2 CPDS
        //
        //            // 2.2.1 Training Condition Prior
        //            Eigen::MatrixXd training_condition_prior =
        //                Eigen::MatrixXd::Ones(1, num_training_conditions); //
        //                Uniform
        //            CategoricalCPD training_condition_cpd_temp(
        //                {}, training_condition_prior);
        //            shared_ptr<CategoricalCPD> training_condition_prior_cpd =
        //                make_shared<CategoricalCPD>(move(training_condition_cpd_temp));
        //
        //            // 2.3 Random Variables
        //            shared_ptr<RandomVariableNode> training_condition =
        //                make_shared<RandomVariableNode>(training_condition_metadata);
        //            training_condition->add_cpd_template(training_condition_prior_cpd);
        //
        //            // 3. Connections
        //            for (int i = 0; i < num_states; i++) {
        //                state->add_parent_link(theta_s_metadatas[i], true);
        //            }
        //        }
