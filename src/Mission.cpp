...
namespace tomcat {
    ...
    Mission::Mission(std::string mission_id_or_path,
        ...
        this->self_report_prompt_time_in_seconds = self_report_prompt_time_in_seconds;
    ...
    void Mission::add_listener(boost::shared_ptr<LocalAgent> tomcat_agent) {
    ...
    void Mission::connect_to_host() {
        ...
        do {
            try {
                ...
                if (attempts >= 3) {
                    throw MissionException("Could not establish connection with the host.",
                                           MissionException::CONNECTION_NOT_ESTABLISHED);
                }
                else {
